...
func genesisStateWithValSet(
	...
	genesisState[authtypes.ModuleName] = mapp.AppCodec().MustMarshalJSON(authGenesis)
	...
	genesisState[stakingtypes.ModuleName] = mapp.AppCodec().MustMarshalJSON(stakingGenesis)
	...
	genesisState[banktypes.ModuleName] = mapp.AppCodec().MustMarshalJSON(bankGenesis)
