...
import (
	...
	"github.com/histolabs/metro/cmd/metro/cmd"
...
// metro network using the provided genesis state. The provided keyring
...
// DefaultNetwork creates an in-process single validator metro network
